...
A_ISTRUCT(A68_CHAR ,57,A68t56);
typedef struct A68t56  A68_56 ;    /* STRUCT 57 CHAR */
struct A68t57{
A68_VC  Word;
A68_INT  Value;
A_PAD_INT(PAD_5)
...
static A68_56   WTJACTR = {"$Id: lookup.c,v 1.5 2004/09/04 16:52:12 teshields Exp $"}; 
A_GISVEC(A68_VC ,XTJACTR,WTJACTR,57)
...
static char *A_config_arguments[] = {"a68toc","-v","-uname","seedfile","-staredit","59LR","-lib","/home/shields/projects/Algol68/Tools/Algol68toC/a68config","-dir","/home/shields/projects/Algol68/Tools/Algol68toC/a68config","-dir","/home/shields/projects/Algol68/Tools/Algol68toC/liba68prel","-dir",".","lookup.a68",""};
