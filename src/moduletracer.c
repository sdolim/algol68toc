...
A_ISTRUCT(A68_CHAR ,63,A68t60);
typedef struct A68t60  A68_60 ;    /* STRUCT 63 CHAR */
struct A68t61{
A68_VC  Name;
A68_INT  Tracelevel;
A_PAD_INT(PAD_1)
...
static A68_60   ECHACTR = {"$Id: moduletracer.c,v 1.5 2004/09/04 16:52:12 teshields Exp $"}; 
A_GISVEC(A68_VC ,FCHACTR,ECHACTR,63)
...
static char *A_config_arguments[] = {"a68toc","-v","-uname","seedfile","-staredit","59LR","-lib","/home/shields/projects/Algol68/Tools/Algol68toC/a68config","-dir","/home/shields/projects/Algol68/Tools/Algol68toC/a68config","-dir","/home/shields/projects/Algol68/Tools/Algol68toC/liba68prel","-dir",".","moduletracer.a68",""};
...
#undef NL
/* end of translation of moduletracer.a68 */
