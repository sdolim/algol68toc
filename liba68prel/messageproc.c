...
A_ISTRUCT(A68_CHAR ,62,A68t42);
typedef struct A68t42  A68_42 ;    /* STRUCT 62 CHAR */
struct A68t44{
A68_INT  Number;
A_PAD_INT(PAD_1)
...
static A68_42   CSAAOSF = {"$Id: messageproc.c,v 1.6 2004/09/04 16:52:11 teshields Exp $"}; 
A_GISVEC(A68_VC ,DSAAOSF,CSAAOSF,62)
...
static char *A_config_arguments[] = {"a68toc","-v","-uname","seedfile","-staredit","59LR","-lib","/home/shields/projects/Algol68/Tools/Algol68toC/a68config","-dir","/home/shields/projects/Algol68/Tools/Algol68toC/a68config","-dir","/home/shields/projects/Algol68/Tools/Algol68toC/liba68prel","messageproc.a68",""};
