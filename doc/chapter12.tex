% $Log: chapter12.tex,v $
% Revision 1.3  2004/09/04 02:37:45  teshields
...
``run-time'' due to \hx{arithmetic overflow}{overflow!arithmetic}.
...
\hx{a68toc}{a68toc!integer overflow} compiler, a number of special
...
\verb|SHORT SHORT INT| (see section \hyref{stan-fpov} for details).
